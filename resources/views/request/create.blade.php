...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form autocomplete="off" method="POST" action="{{ route("request.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="office" id="office" required>
                <span class="help-block"></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="request" id="request" required>
                <span class="help-block"></span>
            </div>

            <div class="form-group">
                <label class="required" for="date_requested">Date</label>
                <input class="form-control" type="date" name="date_requested" id="date_requested" required>
                <span class="help-block"></span>
            </div>
